...
import com.yjjk.monitor.service.SleepingService;
 ...
 */
@Service
public class SleepingServiceImpl extends BaseService implements SleepingService {
...
//                            }
//                        }
//                        if (monitorList.get(i).getTemperature() == null) {
//                            monitorList.get(i).setRecordState(MonitorRecord.RECORD_STATE_ERR_WEAR);
//                        }
//                    }
//                }
...
//        Integer departmentId = super.loginStateMapper.selectDepartmentIdByToken(String.valueOf(paraMap.get("token")));
...
//            return null;
//        }
//        TemperatureBound zsTemperatureBound = super.temperatureBoundMapper.selectByPrimaryKey(zsMachineInfo.getDepartmentId());
//        if (zsTemperatureBound == null) {
//            zsTemperatureBound = super.temperatureBoundMapper.selectByPrimaryKey(TemperatureConstant.DEFAULT_DEPARTMENT_ID);
//        }
//        // 统计高温数据
//        int count = 0;
//        boolean flag = false;
...
//
//    @Override
//    public List<ZsPatientRecord> getUsageByBedId(Integer bedId) {
//        return super.ZsPatientRecordMapper.getUsageByBedId(bedId);
//    }
