...
//            return;
//        }
//        ManagerInfo managerInfo = super.managerService.getManagerInfo(managerId);
//        PatientInfo zsPatientInfo1 = super.patientService.selectByCaseNum(caseNum);
...
//            }
//        }
//        PatientInfo zsPatientInfo = super.patientService.addPatient(name, caseNum, bedId, managerInfo.getDepartmentId());
...
//        /********************** 参数初始化 **********************/
////        ManagerInfo managerInfo = this.managerService.getManagerInfo(managerId);
//        PatientInfo zsPatientInfo = this.patientService.selectByCaseNum(caseNum);
...
//            }
//            stopRecord(recordId);
//            PatientInfo patientInfo = patientService.getByPrimaryKey(patientRecord.getPatientId());
...
//    public CommonResult<List<UseMachineVO>> getMonitors(@ApiParam(value = "科室id", required = true) @RequestParam(value = "departmentId") Integer departmentId,
...
//            }
//            PatientInfo zsPatientInfo = new PatientInfo();
